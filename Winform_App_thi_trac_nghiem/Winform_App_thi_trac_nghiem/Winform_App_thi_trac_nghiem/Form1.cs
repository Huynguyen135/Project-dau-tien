...
namespace Winform_App_thi_trac_nghiem
{
    public partial class Form1 : Form
    {
        ...
        public bool CheckValid()
        {
            ...
            if (txtmacau == null || txtdebai == null || dapan1 == null || dapan3 == null || dapan4 == null)
            {
                MessageBox.Show("Ma cau khong duoc de trong");
                return false;
            }
               
            if (txtmacau.Length > 6)
            {
                MessageBox.Show("Ma cau hoi khong duoc lon hon 6 ki tu");
                txtMaCau.Focus();
                return false;
            }
        ...
        private void btnNhap_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int result = NhapDuLieu.nhapCauhoi(txtmacau, txtdebai, dapan1, dapan2, dapan3, dapan4, hinhanh, loaicauhoi, idbangthi, dapandung);
                if (result > 0)
                {
        ...
        private void btnXuatExel_Click(object sender, EventArgs e)
        {
            ...
            string filePath = @"F:\cong nghe NET\Winform_App_thi_trac_nghiem\Winform_App_thi_trac_nghiem\CauHoi.xlsx";
        ...
        private void btnNhapFile_Click(object sender, EventArgs e)
        {
            ...
            var filepath = @"F:\cong nghe NET\Winform_App_thi_trac_nghiem\Winform_App_thi_trac_nghiem\CauHoi.xlsx";
            try
            {
        ...
        public static void NhapFileExel(string excelFilePath)
        {
            ...
            using (var package = new ExcelPackage(new FileInfo(excelFilePath)))
            {
                ...
                var ColCount = FirstWorksheet.Dimension.Columns; //so cot trong worksheet
                    ...
                    for (int row = 2; row < RowCount; row++) // bo qua dong dau tien (tieu de)
                    {
                        ...
                        //}
                        string idcauhoi = FirstWorksheet.Cells[row, 1].Value?.ToString(); // Cột 1
                        ...
                        string idbangthi = FirstWorksheet.Cells[row, 10].Value?.ToString(); // Cột 9
                     

                        NhapDuLieu.nhapCauhoi(idcauhoi, debai, dapan1, dapan2, dapan3, dapan4, hinhanh, loaicauhoi, idbangthi, dapandung);
                    }
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int result = NhapDuLieu.capnhatCauHoi(txtmacau, txtdebai, dapan1, dapan2, dapan3, dapan4, hinhanh, loaicauhoi, idbangthi, dapandung);
                if (result > 0)
                {
